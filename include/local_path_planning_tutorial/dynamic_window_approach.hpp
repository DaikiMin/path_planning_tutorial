...
inline void local_path_planning_tutorial::DynamicWindowApproach::setVelocityLimit ( const std::vector<double>& lin_range, const std::vector<double>& ang_range, const double max_acc, const double max_ang_acc, const double acc_gain ) {
...
inline void local_path_planning_tutorial::DynamicWindowApproach::setWeight ( const double goal, const double obs, const double ang, const double vel ) {
...
inline void local_path_planning_tutorial::DynamicWindowApproach::setStepValue ( const int predict_step, const double sampling_time, const double vel_step, const double ang_vel_step ) {
	dwap_->predict_step = predict_step;
	dwap_->sampling_time = sampling_time;
	dwap_->vel_step = vel_step;
	dwap_->ang_vel_step = ang_vel_step;
}
inline void local_path_planning_tutorial::DynamicWindowApproach::setDisplayFlag ( const bool is_display_path, const bool is_display_all_path ) {
